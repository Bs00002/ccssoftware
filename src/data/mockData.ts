...
export const INITIAL_PRODUCTS: Product[] = [
  {
    id: 'p-test-workflow-1',
    code: 'PRD-TEST-MAX',
    name: 'Chitra Bio-Shield Max (Workflow Test SKU)',
    technicalName: 'Azotobacter & Bio-Protector Complex 90%',
    category: 'Bio Products',
    packSize: '1 Ltr Bottle',
    mrp: 1450,
    dealerPrice: 1050,
    distributorPrice: 920,
    stock: 800,
    reservedStock: 0,
    warehouse: 'Pune Central Warehouse',
    recommendedCrops: ['Cotton', 'Sugarcane', 'Soybean', 'Paddy'],
    dosage: '2 ml per Ltr water',
    description: 'Premium bio-shield formulation for workflow validation testing.',
  ...
  },
  {
    id: 'p-7',
    code: 'PEST-502',
    name: 'Chitra Crop Shield Max Super',
    technicalName: 'Chlorantraniliprole 18.5% w/w SC',
    category: 'Pesticides',
    packSize: '250 ml',
    mrp: 1850,
    dealerPrice: 1420,
    distributorPrice: 1280,
    stock: 250,
    reservedStock: 10,
    warehouse: 'Pune Central Warehouse',
    recommendedCrops: ['Sugarcane', 'Cotton', 'Paddy', 'Maize'],
    dosage: '0.4 ml per Ltr water',
    description: 'Advanced broad-spectrum foliage crop protector against stem borers and caterpillars.',
  ...
  },
  {
    id: 'p-8',
    code: 'FERT-309',
    name: 'Chitra Nano Zinc Boost Organic',
    technicalName: 'Chelated Zinc 12% EDTA Liquid',
    category: 'Fertilizers',
    packSize: '1 Ltr Bottle',
    mrp: 980,
    dealerPrice: 720,
    distributorPrice: 610,
    stock: 180,
    reservedStock: 5,
    warehouse: 'Aurangabad Plant',
    recommendedCrops: ['Paddy', 'Wheat', 'Citrus', 'Grapes'],
    dosage: '1 ml per Ltr water',
    description: 'Fast-absorption organic chelated micronutrient formula to prevent zinc deficiency.',
...
export const INITIAL_DEALERS: Dealer[] = [
  {
    id: 'd-test-workflow-1',
    code: 'DLR-TEST-880',
    name: 'Kisan Agrotech Test Kendra',
    ownerName: 'Kisan Kendra',
    phone: '+91 99887 76655',
    email: 'test_dealer_workflow@chitracropscience.com',
    city: 'Pune',
    state: 'Maharashtra',
    address: 'Krushi Bazaar Main Road, Pune - 411045',
    gstin: '27AAACK9999K1Z5',
    pan: 'AAACK9999K',
    distributorId: 'u-dist-1',
  ...
  },
  {
    id: 'd-6',
    code: 'SRA-501',
    name: 'Shree Ram Krushi Seva Kendra',
    ownerName: 'Mahesh Deshmukh',
    phone: '+91 98221 33445',
    email: 'shreeram.krushi@gmail.com',
    city: 'Satara',
    state: 'Maharashtra',
    address: 'Main Highway Road, Near Bus Stand, Satara - 415001',
    gstin: '27AABCS1122K1Z6',
    pan: 'AABCS1122K',
    distributorId: 'dist-1',
    distributorName: 'Chitra Sales Corp',
    creditLimit: 350000,
    ...
    totalOrdersCount: 12,
    totalSalesValue: 290000,
    loyaltyPoints: 780,
  },
  {
    id: 'd-7',
    code: 'MAK-602',
    name: 'Mahavir Agro Kendra',
    ownerName: 'Pravin Shah',
    phone: '+91 94235 66778',
    email: 'mahaviragro.solapur@gmail.com',
    city: 'Solapur',
    state: 'Maharashtra',
    address: 'Shop No 15, APMC Market Yard, Solapur - 413002',
    gstin: '27AABCM3344L1Z7',
    pan: 'AABCM3344L',
    distributorId: 'dist-1',
    distributorName: 'Chitra Sales Corp',
    creditLimit: 400000,
